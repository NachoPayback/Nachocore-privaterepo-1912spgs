...
a = Analysis(
    ...
    hiddenimports=['shared.tasks.location_collection', 'shared.tasks.multiple_choice', 'shared.tasks.name_collection', 'shared.tasks.short_answer', 'shared.config', 'shared.theme.theme', 'shared.utils.close_button_blocker', 'shared.utils.keyboard_blocker', 'shared.utils.mouse_locker', 'shared.utils.sleep_blocker', 'shared.utils.security_monitor', 'shared.utils.logger', 'shared.utils.ui_keyboard'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
