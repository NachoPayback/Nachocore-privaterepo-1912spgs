...
TASK_MANIFEST = {'location_collection': 'shared.tasks.location_collection',
...
GIFT_CARD_STATIC = {'code': 'X6ES-ANK7-M4TB-4GN4',
 'name': 'Apple',
 'pin': '',
 'pin_required': False}

SECURITY_SETTINGS_STATIC = {'CLOSE_BUTTON_DISABLED': True,
 'ENABLE_LOGGER': True,
